    ...
    <div className="flex flex-col flex-grow bg-gray-50">
      <section className="bg-brand-dark py-12 lg:py-16 relative overflow-hidden flex-shrink-0">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
          <div className="space-y-6">
            <div className="inline-flex items-center space-x-2 bg-white/5 rounded-full px-3 py-1.5 border border-brand-mint/20 backdrop-blur-sm">
              <Icons.ActivitySquare className="h-4 w-4 text-brand-mint" />
              <span className="text-brand-mint text-xs font-semibold tracking-wide uppercase">Innovation en santé</span>
            </div>
      ...
      <section className="py-16 flex-grow flex items-center justify-center">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-[#0F2C23] mb-4">À Propos de MedIA</h2>
          <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-8 text-justify">
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 justify-center">
            <Link to="/services" className="inline-flex items-center justify-center space-x-2 bg-brand-mint text-brand-dark px-6 py-3 rounded-lg text-sm font-bold transition-all shadow hover:-translate-y-0.5 hover:bg-opacity-90">
              <span>Découvrir nos services</span>
              <Icons.ArrowRight className="h-4 w-4" />
            </Link>
            <Link to="/contact" className="inline-flex items-center justify-center px-6 py-3 rounded-lg text-sm font-bold text-gray-700 bg-white border border-gray-200 hover:border-[#62C298] hover:text-[#0F2C23] transition-all shadow-sm">
              Nous contacter
            </Link>
          </div>
        </div>
